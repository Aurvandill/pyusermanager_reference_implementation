...
class Alert():
    def __init__(self, message = "",type=ALERT_TYPE.SUCCESS):
...
class Modal():
    def __init__(self, message = "",type=MODAL_TYPE.SUCCESS,headline="Hinweis"):
        self.modal_type = type
        self.modal_rec_msg = message
        self.modal_headline = headline

    def to_dict(self):
        tmp_dict = {
            "modal_type":self.modal_type.value,
            "modal_rec_msg":self.modal_rec_msg,
